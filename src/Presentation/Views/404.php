<?php require_once __DIR__ . '/layouts/header.php'; ?>
    ...
    <main class="w-full min-h-[100vh] rounded-b-[30px] flex flex-col justify-center items-center text-center py-20 gap-15 p-6 bg-whitey relative z-10" >
        ...
        <a href="/eletronicoverde" class="bg-primary text-2xl text-white p-4 w-fit h-fit rounded-3xl rounded-tl-none border-2 border-primary relative overflow-hidden z-1
