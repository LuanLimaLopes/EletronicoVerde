<?php require_once __DIR__ . '/layouts/header.php'; ?>
    ...
    <main class="w-full min-h-screen rounded-b-[30px] flex flex-col justify-center items-center text-center py-20 gap-15 p-6 bg-whitey relative z-10" >
        ...
        <h1 class="text-[50em] absolute font-bold opacity-20 italic text-primary -z-2">404</h1>
        <p class="text-3xl font-bold text-cinza-txt">A página que você está procurando não existe.</p>
        <a href="/eletronicoverde" class="bg-primary font-bold text-2xl text-white p-4 w-fit h-fit rounded-3xl rounded-tl-none border-2 border-primary relative overflow-hidden z-1
