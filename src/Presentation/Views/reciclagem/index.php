...
<head>
    ...
    <style type="text/tailwindcss">
        ...
        .secao:nth-child(even){
            @apply bg-fourth/50 py-10 md:py-15;
        }
        ...
        <div class="pt-10 sm:pt-[5rem] h-full flex flex-col gap-30">
            ...
            <div class="secao">
                <div class=" container mx-auto secao-content ">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 h-full max-w-full lg:max-w-2/3">
                        <!-- Card 1 -->
                        <div class="gap-5 rounded-3xl bg-[#03C28A] p-5 text-center flex items-center justify-center flex-col lg:row-span-2 sm:row-span-2 fade-up">
                          <h2 class="text-4xl font-bold text-white font-dm-serif-display"><span class="counter" data-suffix=" milhões">62</span><h2>
                          <p class="text-xl text-[#E6FFF6]">Toneladas de lixo eletrônico foram geradas no mundo em 2022</p>
                        </div>

                        <!-- Card 2 -->
                        <div class="gap-5 rounded-3xl bg-[#7AD9FF] p-5 text-center flex items-center justify-center flex-col lg:col-span-2 fade-up">
                          <h2 class="text-4xl font-bold text-[#033A57] font-dm-serif-display"><span class="counter" data-suffix="º">5</span></h2>
                          <p class="text-xl text-[#08344A]">O Brasil é o 5º maior produtor de lixo eletrônico do mundo.</p>
                        </div>

                        <!-- Card 3 -->
                        <div class="gap-5 rounded-3xl bg-[#005E3B] p-5 text-center flex items-center justify-center flex-col fade-up">
                          <h2 class="text-4xl font-bold text-white font-dm-serif-display"><span class="counter" data-suffix="%">22,3</span></h2>
                          <p class="text-xl text-[#BDEBD1]">Do lixo eletrônico global foi reciclado corretamente.</p>
                        </div>

                        <!-- Card 4 -->
                        <div class="gap-5 rounded-3xl bg-[#FFECA8] p-5 text-center flex items-center justify-center flex-col fade-up">
                          <h2 class="text-4xl font-bold text-[#264021] font-dm-serif-display"><span class="counter" data-suffix="%">87</span></h2>
                          <p class="text-xl text-[#3A472F]">Dos brasileiros afirmam guardar aparelhos eletrônicos.</p>
                        </div>

                        <!-- Card 5 -->
                        <div class="gap-5 rounded-3xl bg-[#009B72] p-5 text-center flex items-center justify-center flex-col lg:col-span-2 fade-up">
                          <h2 class="text-4xl font-bold text-white font-dm-serif-display"><span class="counter" data-suffix=" milhões">40</span></h2>
                          <p class="text-xl text-[#CDF7E8]">De toneladas de metais preciosos são descartadas anualmente.</p>
                        </div>
                    </div>
            ...
            <!-- Impacto Positivo -->
            <div class="secao rounded-b-[30px]">
                <div class=" container mx-auto secao-content ">
                    <h1 class="titulo-secao max-w-full lg:max-w-2/3 text-xl md:text-2xl lg:text-3xl fade-up">
                ...
                <div class="container mx-auto fade-section px-4 mt-20">
