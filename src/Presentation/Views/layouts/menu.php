  ...
  <div id="navbar" class="container py-2 flex flex-row justify-between items-center relative z-10 rounded-2xl p-5 px-8 transition-all duration-300 overflow-hidden">
    <a href="../home/index.php" class="group transition-all duration-150 h-fit">
      <h1 class="text-xl font-bold flex flex-row items-center gap-3.5">
        <img src="../../../../public/assets/images/Logo.png" alt="Logo Eletrônico Verde" class="max-w-15 transition-all duration-150" />
    ...
    <ul id="ul-menu" class="flex flex-row gap-10 text-white font-medium text-lg">
      <li class="relative group">
        <a href="/index.php" class="hover:text-primary transition-all duration-150">Início</a>
        <span class="nav-indicator"></span>
      </li>
      <li class="relative group">
        <a href="../pontos-coleta/index.php" class="hover:text-primary transition-all duration-150">Pontos de Coleta</a>
        <span class="nav-indicator"></span>
      </li>
      <li class="relative group">
        <a href="../materiais/index.php" class="hover:text-primary transition-all duration-150">Materiais Aceitos</a>
        <span class="nav-indicator"></span>
      </li>
      <li class="relative group">
        <a href="../reciclagem/index.php" class="hover:text-primary transition-all duration-150">Reciclagem</a>
        <span class="nav-indicator"></span>
      </li>
    </ul>
